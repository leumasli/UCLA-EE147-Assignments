...
def affine_backward(dout, cache):
    ...
    # ================================================================ #
    x_ND = x.reshape(x.shape[0], -1)  # (N, D)
...
def batchnorm_forward(x, gamma, beta, bn_param):
    ...
    if mode == 'train':
      ...
      # ================================================================ #
        ...
        cache = (x, xhat, sample_var, gamma, beta, eps)
      # ================================================================ #
      # END YOUR CODE HERE
      # ================================================================ #
...
def batchnorm_backward(dout, cache):
    ...
    # ================================================================ #
    x, xhat, sample_var, gamma, beta, eps = cache
    N = dout.shape[0]
    dbeta = np.sum(dout, axis=0)
    dgamma = np.sum(dout * xhat, axis=0)
    coeff = 1 / np.sqrt(sample_var + eps)
    dx = coeff / N * gamma * (N * dout - dbeta - (xhat * dgamma))
...
def dropout_forward(x, dropout_param):
    ...
    if mode == 'train':
        ...
        # ================================================================ #
        mask = np.random.uniform(low=0, high=1, size=x.shape) < p
        out = x * mask
        # ================================================================ #
        # END YOUR CODE HERE
        # ================================================================ #
...
def softmax_loss(x, y):
    ...
    probs = np.exp(x - np.max(x, axis=1, keepdims=True)) + 1e-8
